...
import { Activity, BarChart3, Bell, BrainCircuit, BriefcaseBusiness, Gauge, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'ai-chain-model', labelKey: 'layout.nav.aiChainModel', to: '/ai-chain-model', icon: BrainCircuit },
  ...
  { key: 'intraday-monitor', labelKey: 'layout.nav.intradayMonitor', to: '/intraday-monitor', icon: Activity },
